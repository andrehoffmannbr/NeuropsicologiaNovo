...
CREATE TRIGGER update_laudos_prontuario_updated_at BEFORE UPDATE ON public.laudos_prontuario FOR EACH ROW EXECUTE FUNCTION public.update_laudos_prontuario_updated_at();
